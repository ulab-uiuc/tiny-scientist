...
class ShallowMLP(nn.Module):
    def __init__(
        self, input_dim=768, output_dim=4
    ):  # Correct output_dim to 4 for ag_news
...
def main(out_dir):
    ...
    )  # Lower learning rate for next experiment
    ...
    print("Run 2 - Lowered learning rate to 0.0005")
