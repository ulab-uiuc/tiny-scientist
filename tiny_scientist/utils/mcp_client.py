...
async def search_github_code(
    query: str, client: MCPClient, result_limit: int = 10
) -> Optional[str]:
    ...
    return await client.call_tool(
        "code_search", "search_github_code", query=query, result_limit=result_limit
    )
...
async def search_papers(
    query: str, client: MCPClient, result_limit: int = 3
) -> Optional[str]:
    ...
    return await client.call_tool(
        "paper_search", "search_papers", query=query, result_limit=result_limit
    )


async def generate_diagram(
    section_name: str, section_content: str, client: MCPClient
) -> Optional[str]:
