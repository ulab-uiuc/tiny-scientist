...
class SafetyChecker:
    ...
    def is_idea_safe(self, idea: Dict[str, Any]) -> bool:
        ...
        dangerous_keywords = [
            "weapon", "harm", "attack", "exploit", "malicious", 
            "surveillance", "manipulation", "deception", "toxic",
            "bias", "discrimination", "privacy violation"
        ]
    ...
    def comprehensive_safety_check(self, intent: str, idea: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        result = {
            "intent_safety": {
                "is_safe": is_intent_safe,
                "report": intent_safety_report
            }
        }
        ...
        if idea is not None:
            ...
            result["idea_ethics"] = {
                ...
                "is_ethically_sound": ethics_result["status"] == "success" and quick_safety
            }
        ...
        print(f"🎯 Overall safety assessment: {'SAFE' if overall_safe else 'NEEDS REVIEW'}")
        return result
