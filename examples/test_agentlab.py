...
ROOT = Path("/Users/yuhaofei/Downloads/all_results_full/agentlab_nonbio")
MODEL = "gpt-4o"
...
def main():
    ...
    # 查找存在的报告文件
    report_files = sorted(ROOT.glob("*/tex/temp.tex"))
    ...
    if not report_files:
        print(f"[WARN] no temp.tex under immediate subfolders of {ROOT}")
        return
